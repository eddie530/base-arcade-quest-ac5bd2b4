    ...
    <div className="min-h-screen">
      ...
      <section className="mx-auto max-w-5xl px-4 pt-10 pb-16 text-center">
        ...
        <p className="mx-auto mt-6 max-w-xl text-muted-foreground">
          Quick games. Daily XP. Global leaderboards. Built for the Base ecosystem
          and ready to flex on Farcaster.
        </p>
      ...
      <section id="features" className="mx-auto max-w-5xl px-4 pb-24">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            ...
            { Icon: Coins, t: "Coin Flip", d: "Heads or tails. Risk-free vibes, fully animated." },
            { Icon: Flame, t: "Daily Streaks", d: "Show up every 24h. Bigger streak, bigger payouts." },
            ...
            { Icon: Gamepad2, t: "Base Native", d: "Coinbase Smart Wallet support out of the box." },
          ].map(({ Icon, t, d }) => (
